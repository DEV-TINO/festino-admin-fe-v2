<template>
  <div class="cursor-pointer">
    <svg v-if="isActive" width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="#0073F0"
      />
      <path d="M4.5 4.5H9.5M4.5 7.5H7.5M4.5 10.5H8.5M4.5 13.5H7.5" stroke="white" stroke-linecap="round" />
      <path
