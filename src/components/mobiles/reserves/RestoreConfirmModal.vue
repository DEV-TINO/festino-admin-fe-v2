...
<template>
  <div class="max-w-[500px] w-full h-full fixed top-0 bg-opacity-60 bg-black z-50 flex justify-center items-center px-6" @click="handleClickCloseConfirm()">
    <div class="w-[380px] bg-white rounded-3xl flex flex-col items-center px-10 py-8 gap-5" @click.stop>
      ...
      <div class="flex flex-col items-center gap-4 w-full">
        <div class="font-bold text-xl text-secondary-700">예약 복구 안내</div>
        ...
        <div class="text-secondary-500 text-center">
          <div>해당 예약을 복구하시겠습니까?</div>
          <div>확인 버튼 선택 시, 해당 예약이 복구됩니다.</div>
        </div>
      </div>
