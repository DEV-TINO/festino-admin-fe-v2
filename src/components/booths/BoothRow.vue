...
<template>
  <div
    class="text-second-700-light text-xs lg:text-[14px] h-[55px] w-full flex justify-between gap-2 flex-nowrap overflow-x-auto items-center px-4 lg:px-[50px] last:rounded-b-[20px] last:border-0 border-b-1 border-secondary-300"
    :class="{
  ...
  >
    ...
    <!-- Booth Category -->
    <div class="text-wrap break-keep min-w-[75px] w-[75px] lg:min-w-[140px] lg:w-[140px] text-center">
    ...
    <!-- Go To Booth Detail -->
    <div
      class="text-xs lg:text-[14px] text-nowrap w-[60px] h-[25px] rounded-2xl flex items-center justify-center text-center lg:min-w-[75px] lg:h-[30px] bg-primary-800 lg:rounded-2xl text-primary-900 cursor-pointer select-none font-semibold"
