...
<template>
  <div class="w-[390px] min-w-[325px] bg-white rounded-3xl flex flex-col items-center px-6 py-6 gap-3">
    ...
    <div class="text-secondary-700-light text-2xs flex flex-col items-center">
      <div>커스텀 테이블 번호를 입력해주세요. (예시 : A-1, 최대 10글자)</div>
      <div>미 입력 시 테이블 번호가 자동으로 설정됩니다.</div>
    </div>
    <div class="w-full max-h-[300px] overflow-y-auto justify-between flex flex-wrap">
      <div
